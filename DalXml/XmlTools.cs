...
static class XMLTools
{
    ...
    public static void SaveListToXMLElement(XElement rootElem, string entity)
    {
        ...
        {
            throw new Exceptions.DalXMLFileLoadCreateException($"fail to create xml file: {s_xml_dir + filePath}, {ex.Message}");
        }
    }
    public static XElement LoadListFromXMLElement(string entity)
    {
        ...
        {
            throw new Exceptions.DalXMLFileLoadCreateException($"fail to load xml file: {s_xml_dir + filePath}, {ex.Message}");
        }
    }
    #endregion
    ...
    public static List<T> LoadListFromXMLSerializer<T>(string entity) where T : class
    {
        ...
        {
            throw new Exceptions.DalXMLFileLoadCreateException($"fail to load xml file: {filePath}, {ex.Message}");
        }
    }
    #endregion
}